const SCRIPT_ORDER = [
  ...
  '/modules/raw-data/schema.js',
  '/modules/raw-data/index.js',
];
...
const SCRIPT_VERIFY = {
  ...
  '/modules/raw-data/schema.js': () => Array.isArray(RAW_DATA_LINE_ITEMS) && RAW_DATA_LINE_ITEMS.length > 0,
  '/modules/raw-data/index.js': () => typeof openRawDataMode === 'function',
};
